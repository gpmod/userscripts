...
(function(){
const SCRIPT_DATA={name:"Timelapse Player",version:"2.8",url:"https://gpmod.github.io/userscripts/dist/8033263611069205.user.js"};
...
(new URL(a)).searchParams.get("ex");if(!a)return!0;a=1E3*parseInt(a,16);return isNaN(a)?!0:a<=Date.now()+36E5}async refreshURL(a){this.utils||(this.utils=this.buildUtils());a=this.utils.removeSignedUrlParameters(a);return await this.utils.maybeRefreshAttachmentUrl(a)}buildUtils(){const a=this.findModule(c=>"679164"===c)?.exports;if(a){const c=Object.keys(a).find(b=>{b=a[b].toString();return b.startsWith("async function ")&&b.includes("toURLSafe",15)});if(c){const b={};Object.defineProperty(b,"maybeRefreshAttachmentUrl",
